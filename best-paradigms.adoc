...
TODO,dec2022: revise this document in light of digitstrings.
...
* dual to variadic args, and for langs that actually allow multiple return values, one may as well return a single structure (e.g. list) of data to return.
